...
import NavBannerBg from "@/Components/ResearchProposal/NavBannerBg";

// Dynamically import components
const PubServices = dynamic(() => import("@/Components/AssignmentHelp/PubServices"));
const About = dynamic(() => import("@/Components/ResearchProposal/About"));
...
const AssignmentHelpPage = () => {
  ...
  return (
    <div>
      <Head>
        <title>Research Proposal Help - British Phd Writers.</title>
      </Head>
      <NavBannerBg />
      <PubServices />
      <About ref={aboutRef} />
