...
import NavBannerBg from "@/Components/DissertationHelp/NavBannerBg";

// Dynamically import components
const PubServices = dynamic(() => import("@/Components/AssignmentHelp/PubServices"));
const About = dynamic(() => import("@/Components/DissertationHelp/About"));
...
const AssignmentHelpPage = () => {
  ...
  return (
    <div>
      <Head>
        <title>Dissertation Help - British Phd Writers..</title>
      </Head>
      <NavBannerBg />
      <PubServices />
      <About ref={aboutRef} />
