...
import NavBannerBg from "@/Components/ExamHelp/NavBannerBg";

// Dynamically import components
const PubServices = dynamic(() => import("@/Components/AssignmentHelp/PubServices"));
const About = dynamic(() => import("@/Components/ExamHelp/About"));
...
const AssignmentHelpPage = () => {
  ...
  return (
    <div>
      <Head>
        <title>Online Exam Help - British Phd Writers..</title>
      </Head>
      <NavBannerBg />
      <PubServices />
      <About ref={aboutRef} />
