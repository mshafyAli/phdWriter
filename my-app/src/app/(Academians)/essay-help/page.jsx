...
import NavBannerBg from "@/Components/EssayHelp/NavBannerBg";

// Dynamically import components
const PubServices = dynamic(() => import("@/Components/AssignmentHelp/PubServices"));
const About = dynamic(() => import("@/Components/EssayHelp/About"));
...
const AssignmentHelpPage = () => {
  ...
  return (
    <div>
      <Head>
        <title>Essay Help - British Phd Writers.</title>
      </Head>
      <NavBannerBg />
      <PubServices />
      <About ref={aboutRef} />
